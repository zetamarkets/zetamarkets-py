...
FLEXIBLE_MINTS = {
    ...
    Network.MAINNET: {
        ...
        Asset.GOAT: Pubkey.from_string("Hopt52KvyrefDrjCyU46FRppT217eXT43TS7QbctKjuD"),
        Asset.DRIFT: Pubkey.from_string("Cn7SsBwWfRA9ciM4jYZmYdvxmovVmqXwSbrKbDdu9PSH"),
        Asset.PNUT: Pubkey.from_string("CQvKapickUcQCo22vqgsEU7Ppxw8Z8AvQg38dk1K9ufR"),
        Asset.PENGU: Pubkey.from_string("DWX9YU3tbuFPv9Vk6Gw2nCxcGDjfcy7bx98wgSHyHvbr"),
        Asset.TRUMP: Pubkey.from_string("8wdhnJGejhr2cJ1uNCJ8Q2gf3BhaCHnyiYYoUgAiX33j"),
    },
}
...
PYTH_PRICE_FEEDS = {
    ...
    Network.MAINNET: {
        ...
        Asset.GOAT: Pubkey.from_string("3KebxXoZLaZvvdc3ecmdgwWQWSCLQeuouS6mrF7ar1en"),
        Asset.DRIFT: Pubkey.from_string("9iGAnDv9JbAfV5PUPif7mNu55FoBtJcysYWjfXPAy6ho"),
        Asset.PNUT: Pubkey.from_string("8EWYFU21Gf1rVa93qbpvPxpnfCpRJ1URyXNcbP6EqLAY"),
        Asset.PENGU: Pubkey.from_string("27zzC5wXCeZeuJ3h9uAJzV5tGn6r5Tzo98S1ZceYKEb8"),
        Asset.TRUMP: Pubkey.from_string("9vNb2tQoZ8bB4vzMbQLWViGwNaDJVtct13AGgno1wazp"),
    },
}
...
ZETA_LUT = {
    ...
    Network.MAINNET: [
        ...
        AddressLookupTableAccount(  # GOAT, DRIFT, PNUT, PENGU and TRUMP assets only
            key=Pubkey.from_string("Cf4n9ctn2mYCY4vAsff9CAADuUacuQEUMAGC1UkHFfTh"),
            addresses=[
                Pubkey.from_string("8eExPiLp47xbSDYkbuem4qnLUpbLTfZBeFuEJoh6EUr2"),
                Pubkey.from_string("BbKFezrmKD83PeVh74958MzgFAue1pZptipSNLz5ccpk"),
                Pubkey.from_string("zDEXqXEG7gAyxb1Kg9mK5fPnUdENCGKzWrM21RMdWRq"),
                ...
                Pubkey.from_string("AVNMK6wiGfppdQNg9WKfMRBXefDPGZFh2f3o1fRbgN8n"),
                Pubkey.from_string("SysvarRent111111111111111111111111111111111"),
                Pubkey.from_string("3KebxXoZLaZvvdc3ecmdgwWQWSCLQeuouS6mrF7ar1en"),
                Pubkey.from_string("86oN5x4b7rVvng9ANtJ7jP4ChuGem9PvbMb4Vvop1Y69"),
                Pubkey.from_string("3GSDJPes1uLfPzv4ViSZAvyxqGvUwQM1Vv6dnpd4LdeM"),
                Pubkey.from_string("EdCPYtUn9WduEYf2gS7n7Fip8Cw6jkkgsRjcWX5Q7e8"),
                Pubkey.from_string("CWrAkni9WC7mSxKCsv3StimfZRSYcJ5sBB7tLoxgUBuS"),
                Pubkey.from_string("GTKAVsXT8apxKhLbUqVCACEPjRVA66uSJzoMAibkgtGU"),
                Pubkey.from_string("71k2z4Mn1ESJ22PAjkdyTW4YVqQEGdWNrvnn8k2NuWmX"),
                Pubkey.from_string("qVxV29uwYiSBXXWPSkWrsU2UUfBSoveGnechxbzt4Uo"),
                Pubkey.from_string("DqjpmdxvRCQd8rLq652Dn2PEVPFZKzmnuRtQ3ZdLLMkf"),
                Pubkey.from_string("9b1kgg9KZ18Y23CnQ8wegapMa8GWwuoTB1YBBhCA9PkU"),
                Pubkey.from_string("DupYRDMX3g79CfWHPPCmydmFkTsfZxnQiR8Tc2V4TkKh"),
                Pubkey.from_string("8U8jaYGkTG1CMyzXLUdcm4DxRqrVcSkXxYHiTGYKt6o7"),
                Pubkey.from_string("9iGAnDv9JbAfV5PUPif7mNu55FoBtJcysYWjfXPAy6ho"),
                Pubkey.from_string("2TvxtfiurRpcnPVXaiJ69w32thrycxtTu5oyCT7C8Lhk"),
                Pubkey.from_string("rV9m2wkmpmNYkr2mHAEtt5BvCtuV67kiHVeBEvdSpEj"),
                Pubkey.from_string("A2iug9YmcFw4H3UB4UWSnDxd9DpxodjVMNXRzqXWcMyQ"),
                Pubkey.from_string("CGDyS6HuYjXGsybxo3gZwSsmkzUGFvASYSy6xg7qiFfT"),
                Pubkey.from_string("HJbanxXbnhR9YVtciBosg45MnMcdh55XWg5vcsMe4X1t"),
                Pubkey.from_string("6coVvQmZUSdWnmJFqYWafxvEbSKJQmoHnE2kbYvC67g3"),
                Pubkey.from_string("9uJ9mwcwYPQWvmGEDiomvq2768QdpptyFHtDM5fPm46T"),
                Pubkey.from_string("HCqyfmqoJ1Bvitk2F1ms59x3tbn2myHv9EzBTEdMwhWd"),
                Pubkey.from_string("2wDdQqVY8G6vERUzE51JJyoeJywwAcYWyXPKerEK4npi"),
                Pubkey.from_string("BEN3BWw9nGYW92FWP89S5gPqCzc3Bq3muaNB7JkoteYR"),
                Pubkey.from_string("7Dh3ZvJoxeoZDg53w6y6zEiFhBqF9uPoHrXX1rDrb9FQ"),
                Pubkey.from_string("8EWYFU21Gf1rVa93qbpvPxpnfCpRJ1URyXNcbP6EqLAY"),
                Pubkey.from_string("35AY5ZUHzRfsX54dCfQmG2ZKtYyJxGV2kth8LtUFPqaX"),
                Pubkey.from_string("4d3pAeHp8ob2r1RWaC7btRaxN56eowAKeLvVgefUWUCq"),
                Pubkey.from_string("2LhzWJ8XdoYNHctMRxSjiw94Y9gE59NfgrjRbCvQ6kA3"),
                Pubkey.from_string("FqrFgJp4gMywZogRopVPnefALcVENXURgrCqsuufU6W6"),
                Pubkey.from_string("FzsuGX9VFf118QPnXsyyMustPd8fwGBwA2LjLSBF5VQA"),
                Pubkey.from_string("5XSw9Qnip9Eaw9wn3wNpVd2uXuvvYZcBdsF5t6dk9hm8"),
                Pubkey.from_string("EtQAFfEjGowmzMqHPCyzwMLjqskW3G8c8PnB3FVB4cbF"),
                Pubkey.from_string("4yQrSfHjfDzDdwnu56rdiMua1Ga1vBW9aFwcmS3sqKY9"),
                Pubkey.from_string("Fd4fzvKXpRVUPYoZ6hN6Pqdun5Hg6JWo1krKJ9qLw4ng"),
                Pubkey.from_string("HTBnoCV4V3Y2eZHzir66GnxGpZJWvVb7biG4xHWQc3eM"),
                Pubkey.from_string("4EPKg65QiC6XQySWqyNQDh5puLdvp48U2biWS6bhoQfM"),
                Pubkey.from_string("27zzC5wXCeZeuJ3h9uAJzV5tGn6r5Tzo98S1ZceYKEb8"),
                Pubkey.from_string("4puTra4629dzn3brpRJo57wpVsgHPFy4iVW9d8qTWppG"),
                Pubkey.from_string("EmvG8Xq9rZyLVC88zqNS613waHKuTyzF6edXqKBNztqx"),
                Pubkey.from_string("Aed2gMU38b5KoD9H8yMBxRAHehJhws5bSxRcEnb9mDAi"),
                Pubkey.from_string("J4nSJpmMKGhXuEhVtFMZiQH4beWdPFt5iK23EyhPZEnS"),
                Pubkey.from_string("HwWQzaKnVERDdvbUknZywZtAtps981DqRbVGTXLNq2DK"),
                Pubkey.from_string("9gt2ynnLjF6QsbMcoaXJXrEco4kAGHJrK9aDeBbwquW"),
                Pubkey.from_string("aLEXpuUWGMvHpTKakAefKbT8qZq1FayvvwDLC8HHrmz"),
                Pubkey.from_string("5cb3zJ3CEYZCJR89A8MjXtSfTtncac9d5XVBp9yvLWrB"),
                Pubkey.from_string("7PjFz2Vy1n6SxWweZGcsFc9gS32u6f2iBjSAPGUzpyQb"),
                Pubkey.from_string("GV6ExHe5u6ZZdPaiRy4z5nUr3WBC74kd7iKoyeQnisy6"),
                Pubkey.from_string("A685eW8k4GpZ7vsZN1gWQMJc5oJ3kjuCHheRhDQwaag4"),
                Pubkey.from_string("9vNb2tQoZ8bB4vzMbQLWViGwNaDJVtct13AGgno1wazp"),
                Pubkey.from_string("HzFxs6q3auTytN9nfVmdSBt5ww3sd6FHkeX7g6LpGKWp"),
                Pubkey.from_string("DkXMBQL5pYUmwbiLp72Ez1Xbbiics2vVCu9QhG1FgAro"),
                Pubkey.from_string("FS7kX7gaPnK4napESPNvAZLPfGYjqgey2RkEoBT9jGmq"),
                Pubkey.from_string("GqMRWarRufyv3CBQEAkxPovJhbjhnToQHXoLEXTxeVeJ"),
                Pubkey.from_string("4Z7oSdWJGt8DFMrnzJGR2CWWhJFp2Aiv3eGegwtjfMoN"),
                Pubkey.from_string("EaLHYaRbLdZq7n8P6EDyzSfD2sgXnhNFPpNMDLBe3aUp"),
                Pubkey.from_string("3XoGTUfoYezZ2iecgzZ72NpQpW7wxdesq8fXYXv1KqAv"),
                Pubkey.from_string("G6up7p678aVxaUMuuyUfF23mZdc3135CiN3DBqMUjQBu"),
                Pubkey.from_string("HwSYZMwXMuhSmLAnmuha6j5uF4gvpmJ1RRE87KhYeEFn"),
                Pubkey.from_string("ApUUa8FYWCFCAaVTmhY4mpJv4qTkYCJTszQdAvUy7Jkx"),
                Pubkey.from_string("ECuNBJCGxUAe2BQRxZiEKvmru3uzGBZoLanUTFsqR5Zq"),
            ],
        ),
    ],
}
