...
class CrossMarginAccount:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "open_orders_nonces" / borsh.U8[12],
        "open_orders_nonces_padding" / borsh.U8[13],
        "rebalance_amount" / borsh.I64,
        "last_funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[12],
        "last_funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[13],
        "product_ledgers" / types.product_ledger.ProductLedger.layout[12],
        "product_ledgers_padding" / types.product_ledger.ProductLedger.layout[13],
