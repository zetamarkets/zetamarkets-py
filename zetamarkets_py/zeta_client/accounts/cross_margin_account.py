...
class CrossMarginAccount:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "open_orders_nonces" / borsh.U8[20],
        "open_orders_nonces_padding" / borsh.U8[5],
        "rebalance_amount" / borsh.I64,
        "last_funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[20],
        "last_funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[5],
        "product_ledgers" / types.product_ledger.ProductLedger.layout[20],
        "product_ledgers_padding" / types.product_ledger.ProductLedger.layout[5],
        "trigger_order_bits" / borsh.U128,
        "rebate_rebalance_amount" / borsh.U64,
        "potential_order_loss" / borsh.U64[20],
        "potential_order_loss_padding" / borsh.U64[5],
