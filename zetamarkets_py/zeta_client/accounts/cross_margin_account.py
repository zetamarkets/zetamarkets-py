...
class CrossMarginAccount:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "open_orders_nonces" / borsh.U8[21],
        "open_orders_nonces_padding" / borsh.U8[4],
        "rebalance_amount" / borsh.I64,
        "last_funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[21],
        "last_funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[4],
        "product_ledgers" / types.product_ledger.ProductLedger.layout[21],
        "product_ledgers_padding" / types.product_ledger.ProductLedger.layout[4],
        "trigger_order_bits" / borsh.U128,
        "rebate_rebalance_amount" / borsh.U64,
        "potential_order_loss" / borsh.U64[21],
        "potential_order_loss_padding" / borsh.U64[4],
