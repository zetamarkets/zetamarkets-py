...
class CrossMarginAccount:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "open_orders_nonces" / borsh.U8[14],
        "open_orders_nonces_padding" / borsh.U8[11],
        "rebalance_amount" / borsh.I64,
        "last_funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[14],
        "last_funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[11],
        "product_ledgers" / types.product_ledger.ProductLedger.layout[14],
        "product_ledgers_padding" / types.product_ledger.ProductLedger.layout[11],
