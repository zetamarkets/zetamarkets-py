...
class CrossMarginAccount:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "open_orders_nonces" / borsh.U8[8],
        "open_orders_nonces_padding" / borsh.U8[17],
        "rebalance_amount" / borsh.I64,
        "last_funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[8],
        "last_funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[17],
        "product_ledgers" / types.product_ledger.ProductLedger.layout[8],
        "product_ledgers_padding" / types.product_ledger.ProductLedger.layout[17],
