...
class CrossMarginAccount:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "open_orders_nonces" / borsh.U8[15],
        "open_orders_nonces_padding" / borsh.U8[10],
        "rebalance_amount" / borsh.I64,
        "last_funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[15],
        "last_funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[10],
