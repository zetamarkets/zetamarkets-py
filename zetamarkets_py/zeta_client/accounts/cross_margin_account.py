...
class CrossMarginAccount:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "open_orders_nonces" / borsh.U8[10],
        "open_orders_nonces_padding" / borsh.U8[15],
        "rebalance_amount" / borsh.I64,
        "last_funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[10],
        "last_funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[15],
        "product_ledgers" / types.product_ledger.ProductLedger.layout[10],
        "product_ledgers_padding" / types.product_ledger.ProductLedger.layout[15],
