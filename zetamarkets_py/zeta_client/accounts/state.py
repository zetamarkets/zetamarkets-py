...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[24],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[1],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[24],
        "min_lot_sizes_padding" / borsh.U32[1],
        "tick_sizes" / borsh.U32[24],
        "tick_sizes_padding" / borsh.U32[1],
