...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[20],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[5],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[20],
        "min_lot_sizes_padding" / borsh.U32[5],
        "tick_sizes" / borsh.U32[20],
        "tick_sizes_padding" / borsh.U32[5],
