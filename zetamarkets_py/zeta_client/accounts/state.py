...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[19],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[6],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[19],
        "min_lot_sizes_padding" / borsh.U32[6],
        "tick_sizes" / borsh.U32[19],
        "tick_sizes_padding" / borsh.U32[6],
