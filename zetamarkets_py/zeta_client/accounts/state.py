...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[22],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[3],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[22],
        "min_lot_sizes_padding" / borsh.U32[3],
        "tick_sizes" / borsh.U32[22],
        "tick_sizes_padding" / borsh.U32[3],
