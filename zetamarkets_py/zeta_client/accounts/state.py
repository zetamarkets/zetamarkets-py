...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[18],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[7],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[18],
        "min_lot_sizes_padding" / borsh.U32[7],
        "tick_sizes" / borsh.U32[18],
        "tick_sizes_padding" / borsh.U32[7],
