...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[23],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[2],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[23],
        "min_lot_sizes_padding" / borsh.U32[2],
        "tick_sizes" / borsh.U32[23],
        "tick_sizes_padding" / borsh.U32[2],
