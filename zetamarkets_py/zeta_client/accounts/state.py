...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[25],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[0],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[25],
        "min_lot_sizes_padding" / borsh.U32[0],
        "tick_sizes" / borsh.U32[25],
        "tick_sizes_padding" / borsh.U32[0],
