...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[16],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[9],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[16],
        "min_lot_sizes_padding" / borsh.U32[9],
        "tick_sizes" / borsh.U32[16],
        "tick_sizes_padding" / borsh.U32[9],
