...
class State:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        ...
        "halt_states" / types.halt_state_v2.HaltStateV2.layout[17],
        "halt_states_padding" / types.halt_state_v2.HaltStateV2.layout[8],
        "trigger_admin" / BorshPubkey,
        "min_lot_sizes" / borsh.U32[17],
        "min_lot_sizes_padding" / borsh.U32[8],
        "tick_sizes" / borsh.U32[17],
        "tick_sizes_padding" / borsh.U32[8],
