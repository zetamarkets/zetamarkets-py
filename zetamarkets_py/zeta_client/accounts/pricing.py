...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[19],
        "mark_prices_padding" / borsh.U64[6],
        "update_timestamps" / borsh.U64[19],
        "update_timestamps_padding" / borsh.U64[6],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[19],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[6],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[19],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[6],
        "latest_midpoints" / borsh.U64[19],
        "latest_midpoints_padding" / borsh.U64[6],
        "oracles" / BorshPubkey[19],
        "oracles_padding" / BorshPubkey[6],
        "oracle_backup_feeds" / BorshPubkey[19],
        "oracle_backup_feeds_padding" / BorshPubkey[6],
        "markets" / BorshPubkey[19],
        "markets_padding" / BorshPubkey[6],
        "perp_sync_queues" / BorshPubkey[19],
        "perp_sync_queues_padding" / BorshPubkey[6],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[19],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[6],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[19],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[6],
        "products" / types.product.Product.layout[19],
        "products_padding" / types.product.Product.layout[6],
        "zeta_group_keys" / BorshPubkey[19],
        "zeta_group_keys_padding" / BorshPubkey[6],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[19],
        "halt_force_pricing_padding" / borsh.Bool[6],
