...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[10],
        "mark_prices_padding" / borsh.U64[15],
        "update_timestamps" / borsh.U64[10],
        "update_timestamps_padding" / borsh.U64[15],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[10],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[15],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[10],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[15],
        "latest_midpoints" / borsh.U64[10],
        "latest_midpoints_padding" / borsh.U64[15],
        "oracles" / BorshPubkey[10],
        "oracles_padding" / BorshPubkey[15],
        "oracle_backup_feeds" / BorshPubkey[10],
        "oracle_backup_feeds_padding" / BorshPubkey[15],
        "markets" / BorshPubkey[10],
        "markets_padding" / BorshPubkey[15],
        "perp_sync_queues" / BorshPubkey[10],
        "perp_sync_queues_padding" / BorshPubkey[15],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[10],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[15],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[10],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[15],
        "products" / types.product.Product.layout[10],
        "products_padding" / types.product.Product.layout[15],
        "zeta_group_keys" / BorshPubkey[10],
        "zeta_group_keys_padding" / BorshPubkey[15],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[10],
        "halt_force_pricing_padding" / borsh.Bool[15],
