...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[24],
        "mark_prices_padding" / borsh.U64[1],
        "update_timestamps" / borsh.U64[24],
        "update_timestamps_padding" / borsh.U64[1],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[24],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[1],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[24],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[1],
        "latest_midpoints" / borsh.U64[24],
        "latest_midpoints_padding" / borsh.U64[1],
        "oracles" / BorshPubkey[24],
        "oracles_padding" / BorshPubkey[1],
        "oracle_backup_feeds" / BorshPubkey[24],
        "oracle_backup_feeds_padding" / BorshPubkey[1],
        "markets" / BorshPubkey[24],
        "markets_padding" / BorshPubkey[1],
        "perp_sync_queues" / BorshPubkey[24],
        "perp_sync_queues_padding" / BorshPubkey[1],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[24],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[1],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[24],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[1],
        "products" / types.product.Product.layout[24],
        "products_padding" / types.product.Product.layout[1],
        "zeta_group_keys" / BorshPubkey[24],
        "zeta_group_keys_padding" / BorshPubkey[1],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[24],
        "halt_force_pricing_padding" / borsh.Bool[1],
