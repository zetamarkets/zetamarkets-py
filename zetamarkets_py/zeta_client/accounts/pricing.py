...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[14],
        "mark_prices_padding" / borsh.U64[11],
        "update_timestamps" / borsh.U64[14],
        "update_timestamps_padding" / borsh.U64[11],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[14],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[11],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[14],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[11],
        "latest_midpoints" / borsh.U64[14],
        "latest_midpoints_padding" / borsh.U64[11],
        "oracles" / BorshPubkey[14],
        "oracles_padding" / BorshPubkey[11],
        "oracle_backup_feeds" / BorshPubkey[14],
        "oracle_backup_feeds_padding" / BorshPubkey[11],
        "markets" / BorshPubkey[14],
        "markets_padding" / BorshPubkey[11],
        "perp_sync_queues" / BorshPubkey[14],
        "perp_sync_queues_padding" / BorshPubkey[11],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[14],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[11],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[14],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[11],
        "products" / types.product.Product.layout[14],
        "products_padding" / types.product.Product.layout[11],
        "zeta_group_keys" / BorshPubkey[14],
        "zeta_group_keys_padding" / BorshPubkey[11],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[14],
        "halt_force_pricing_padding" / borsh.Bool[11],
