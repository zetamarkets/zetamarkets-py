...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[13],
        "mark_prices_padding" / borsh.U64[12],
        "update_timestamps" / borsh.U64[13],
        "update_timestamps_padding" / borsh.U64[12],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[13],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[12],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[13],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[12],
        "latest_midpoints" / borsh.U64[13],
        "latest_midpoints_padding" / borsh.U64[12],
        "oracles" / BorshPubkey[13],
        "oracles_padding" / BorshPubkey[12],
        "oracle_backup_feeds" / BorshPubkey[13],
        "oracle_backup_feeds_padding" / BorshPubkey[12],
        "markets" / BorshPubkey[13],
        "markets_padding" / BorshPubkey[12],
        "perp_sync_queues" / BorshPubkey[13],
        "perp_sync_queues_padding" / BorshPubkey[12],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[13],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[12],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[13],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[12],
        "products" / types.product.Product.layout[13],
        "products_padding" / types.product.Product.layout[12],
        "zeta_group_keys" / BorshPubkey[13],
        "zeta_group_keys_padding" / BorshPubkey[12],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[13],
        "halt_force_pricing_padding" / borsh.Bool[12],
