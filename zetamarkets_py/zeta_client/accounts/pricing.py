...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[23],
        "mark_prices_padding" / borsh.U64[2],
        "update_timestamps" / borsh.U64[23],
        "update_timestamps_padding" / borsh.U64[2],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[23],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[2],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[23],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[2],
        "latest_midpoints" / borsh.U64[23],
        "latest_midpoints_padding" / borsh.U64[2],
        "oracles" / BorshPubkey[23],
        "oracles_padding" / BorshPubkey[2],
        "oracle_backup_feeds" / BorshPubkey[23],
        "oracle_backup_feeds_padding" / BorshPubkey[2],
        "markets" / BorshPubkey[23],
        "markets_padding" / BorshPubkey[2],
        "perp_sync_queues" / BorshPubkey[23],
        "perp_sync_queues_padding" / BorshPubkey[2],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[23],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[2],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[23],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[2],
        "products" / types.product.Product.layout[23],
        "products_padding" / types.product.Product.layout[2],
        "zeta_group_keys" / BorshPubkey[23],
        "zeta_group_keys_padding" / BorshPubkey[2],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[23],
        "halt_force_pricing_padding" / borsh.Bool[2],
