...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[22],
        "mark_prices_padding" / borsh.U64[3],
        "update_timestamps" / borsh.U64[22],
        "update_timestamps_padding" / borsh.U64[3],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[22],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[3],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[22],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[3],
        "latest_midpoints" / borsh.U64[22],
        "latest_midpoints_padding" / borsh.U64[3],
        "oracles" / BorshPubkey[22],
        "oracles_padding" / BorshPubkey[3],
        "oracle_backup_feeds" / BorshPubkey[22],
        "oracle_backup_feeds_padding" / BorshPubkey[3],
        "markets" / BorshPubkey[22],
        "markets_padding" / BorshPubkey[3],
        "perp_sync_queues" / BorshPubkey[22],
        "perp_sync_queues_padding" / BorshPubkey[3],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[22],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[3],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[22],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[3],
        "products" / types.product.Product.layout[22],
        "products_padding" / types.product.Product.layout[3],
        "zeta_group_keys" / BorshPubkey[22],
        "zeta_group_keys_padding" / BorshPubkey[3],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[22],
        "halt_force_pricing_padding" / borsh.Bool[3],
