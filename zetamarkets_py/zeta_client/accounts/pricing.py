...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[17],
        "mark_prices_padding" / borsh.U64[8],
        "update_timestamps" / borsh.U64[17],
        "update_timestamps_padding" / borsh.U64[8],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[17],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[8],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[17],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[8],
        "latest_midpoints" / borsh.U64[17],
        "latest_midpoints_padding" / borsh.U64[8],
        "oracles" / BorshPubkey[17],
        "oracles_padding" / BorshPubkey[8],
        "oracle_backup_feeds" / BorshPubkey[17],
        "oracle_backup_feeds_padding" / BorshPubkey[8],
        "markets" / BorshPubkey[17],
        "markets_padding" / BorshPubkey[8],
        "perp_sync_queues" / BorshPubkey[17],
        "perp_sync_queues_padding" / BorshPubkey[8],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[17],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[8],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[17],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[8],
        "products" / types.product.Product.layout[17],
        "products_padding" / types.product.Product.layout[8],
        "zeta_group_keys" / BorshPubkey[17],
        "zeta_group_keys_padding" / BorshPubkey[8],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[17],
        "halt_force_pricing_padding" / borsh.Bool[8],
