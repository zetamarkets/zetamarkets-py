...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[9],
        "mark_prices_padding" / borsh.U64[16],
        "update_timestamps" / borsh.U64[9],
        "update_timestamps_padding" / borsh.U64[16],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[9],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[16],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[9],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[16],
        "latest_midpoints" / borsh.U64[9],
        "latest_midpoints_padding" / borsh.U64[16],
        "oracles" / BorshPubkey[9],
        "oracles_padding" / BorshPubkey[16],
        "oracle_backup_feeds" / BorshPubkey[9],
        "oracle_backup_feeds_padding" / BorshPubkey[16],
        "markets" / BorshPubkey[9],
        "markets_padding" / BorshPubkey[16],
        "perp_sync_queues" / BorshPubkey[9],
        "perp_sync_queues_padding" / BorshPubkey[16],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[9],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[16],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[9],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[16],
        "products" / types.product.Product.layout[9],
        "products_padding" / types.product.Product.layout[16],
        "zeta_group_keys" / BorshPubkey[9],
        "zeta_group_keys_padding" / BorshPubkey[16],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[9],
        "halt_force_pricing_padding" / borsh.Bool[16],
