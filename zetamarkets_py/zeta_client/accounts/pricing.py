...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[25],
        "mark_prices_padding" / borsh.U64[0],
        "update_timestamps" / borsh.U64[25],
        "update_timestamps_padding" / borsh.U64[0],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[25],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[0],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[25],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[0],
        "latest_midpoints" / borsh.U64[25],
        "latest_midpoints_padding" / borsh.U64[0],
        "oracles" / BorshPubkey[25],
        "oracles_padding" / BorshPubkey[0],
        "oracle_backup_feeds" / BorshPubkey[25],
        "oracle_backup_feeds_padding" / BorshPubkey[0],
        "markets" / BorshPubkey[25],
        "markets_padding" / BorshPubkey[0],
        "perp_sync_queues" / BorshPubkey[25],
        "perp_sync_queues_padding" / BorshPubkey[0],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[25],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[0],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[25],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[0],
        "products" / types.product.Product.layout[25],
        "products_padding" / types.product.Product.layout[0],
        "zeta_group_keys" / BorshPubkey[25],
        "zeta_group_keys_padding" / BorshPubkey[0],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[25],
        "halt_force_pricing_padding" / borsh.Bool[0],
