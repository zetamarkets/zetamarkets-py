...
class Pricing:
    ...
    layout: typing.ClassVar = borsh.CStruct(
        "nonce" / borsh.U8,
        "mark_prices" / borsh.U64[20],
        "mark_prices_padding" / borsh.U64[5],
        "update_timestamps" / borsh.U64[20],
        "update_timestamps_padding" / borsh.U64[5],
        "funding_deltas" / types.anchor_decimal.AnchorDecimal.layout[20],
        "funding_deltas_padding" / types.anchor_decimal.AnchorDecimal.layout[5],
        "latest_funding_rates" / types.anchor_decimal.AnchorDecimal.layout[20],
        "latest_funding_rates_padding" / types.anchor_decimal.AnchorDecimal.layout[5],
        "latest_midpoints" / borsh.U64[20],
        "latest_midpoints_padding" / borsh.U64[5],
        "oracles" / BorshPubkey[20],
        "oracles_padding" / BorshPubkey[5],
        "oracle_backup_feeds" / BorshPubkey[20],
        "oracle_backup_feeds_padding" / BorshPubkey[5],
        "markets" / BorshPubkey[20],
        "markets_padding" / BorshPubkey[5],
        "perp_sync_queues" / BorshPubkey[20],
        "perp_sync_queues_padding" / BorshPubkey[5],
        "perp_parameters" / types.perp_parameters.PerpParameters.layout[20],
        "perp_parameters_padding" / types.perp_parameters.PerpParameters.layout[5],
        "margin_parameters" / types.margin_parameters.MarginParameters.layout[20],
        "margin_parameters_padding" / types.margin_parameters.MarginParameters.layout[5],
        "products" / types.product.Product.layout[20],
        "products_padding" / types.product.Product.layout[5],
        "zeta_group_keys" / BorshPubkey[20],
        "zeta_group_keys_padding" / BorshPubkey[5],
        "total_insurance_vault_deposits" / borsh.U64,
        "last_withdraw_timestamp" / borsh.U64,
        "net_outflow_sum" / borsh.I64,
        "halt_force_pricing" / borsh.Bool[20],
        "halt_force_pricing_padding" / borsh.Bool[5],
