...
class PlacePerpOrderV5Args(typing.TypedDict):
    price: int
    size: int
...
layout = borsh.CStruct(
    ...
    "self_trade_behavior" / borsh.Option(types.self_trade_behavior_zeta.layout),
)


class PlacePerpOrderV5Accounts(typing.TypedDict):
    authority: Pubkey
...
def place_perp_order_v5(
    args: PlacePerpOrderV5Args,
    accounts: PlacePerpOrderV5Accounts,
    ...
    identifier = b"\x07\x18\xb6\x19\x9b\x90K2"
