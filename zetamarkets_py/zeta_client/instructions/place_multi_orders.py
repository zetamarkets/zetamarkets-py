...
class PlaceMuliOrdersAccounts(typing.TypedDict):
    authority: Pubkey
    state: Pubkey
    pricing: Pubkey
...
def place_multi_orders(
    ...
    accounts: PlaceMuliOrdersAccounts,
    ...
    keys: list[AccountMeta] = [
        ...
        AccountMeta(
            pubkey=accounts["pricing"],
            is_signer=False,
            is_writable=False,
        ),
        AccountMeta(
            pubkey=accounts["margin_account"],
            is_signer=False,
            is_writable=True,
        ),
        AccountMeta(
            pubkey=accounts["dex_program"],
            is_signer=False,
            is_writable=False,
        ),
        AccountMeta(pubkey=TOKEN_PROGRAM_ID, is_signer=False, is_writable=False),
        AccountMeta(
            pubkey=accounts["serum_authority"],
            is_signer=False,
            is_writable=False,
        ),
        AccountMeta(
            pubkey=accounts["open_orders"],
            is_signer=False,
            is_writable=True,
        ),
        ...
        AccountMeta(
            pubkey=accounts["zeta_base_vault"],
            is_signer=False,
            is_writable=True,
        ),
        AccountMeta(
            pubkey=accounts["zeta_quote_vault"],
            is_signer=False,
            is_writable=True,
        ),
        AccountMeta(
        ...
        AccountMeta(
            pubkey=accounts["oracle_backup_feed"],
            is_signer=False,
            is_writable=False,
        ),
        AccountMeta(
            pubkey=accounts["oracle_backup_program"],
            is_signer=False,
            is_writable=False,
        ),
        AccountMeta(
            pubkey=accounts["market_base_mint"],
            is_signer=False,
            is_writable=True,
        ),
        AccountMeta(
            pubkey=accounts["market_quote_mint"],
            is_signer=False,
            is_writable=True,
        ),
        AccountMeta(
            pubkey=accounts["mint_authority"],
            is_signer=False,
            is_writable=False,
        ),
        AccountMeta(
            pubkey=accounts["perp_sync_queue"],
            is_signer=False,
            is_writable=True,
        ),
    ]
