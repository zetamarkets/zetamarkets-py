...
class ForceCancelOrderByOrderIdV2Args(typing.TypedDict):
...
class ForceCancelOrderByOrderIdV2Accounts(typing.TypedDict):
    pricing: Pubkey
    oracle: Pubkey
...
def force_cancel_order_by_order_id_v2(
    args: ForceCancelOrderByOrderIdV2Args,
    accounts: ForceCancelOrderByOrderIdV2Accounts,
    ...
    identifier = b"Q\xf3<Z\xde\xc9)\xde"
